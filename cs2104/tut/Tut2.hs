{-  Tutorial 2 
.
 We will discuss this for the week of 31 Aug 2020
 Please work throught these examples before the tutorial.
 Please also select a topic for presentation on language constructs
 for Week 4 or Types for Week 5. Feel free to propose you\r own topics
 in these two broad areas, but keep it to 5-10mins.
...
{--
  Discussion : 
      Why are there so many ways of computing fibonacci?
      How are they related to one another?
	  Can you prove that they are computing the same result?
	  Can you develop a logarithmic-time fibonacci function,
	  assuming that "+" is constant time.
	  --}