...
sumOfMixList2 ms = error "To be implemented"
...
minTree t = error "To be implemented"
...
flattenPostfix (Node v leftTree rightTree) = error "To be implemented"
...
powerTailRecursive x n =
  let
    aux :: Int -> Int -> Int -> Int
    aux x n acc = error "To be implemented"
  in
    aux x n 1
