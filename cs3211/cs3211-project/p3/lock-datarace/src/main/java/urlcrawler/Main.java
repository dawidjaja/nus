...
public class Main {
    ...
    private static Options specifyOptions() {
        ...
        Option event = new Option("event", true, "Path to the list of events.");
    ...
    private static void readArgs(CommandLine cmd) throws IllegalStateException {
        ...
        eventFile = cmd.getOptionValue("event");
        ...
        String numOfStoredPagesStr = cmd.getOptionValue("storedPageNum");

        Url.maxNumOfStoredPages = Integer.parseInt(numOfStoredPagesStr);

        EventScheduler.shared.readEventSchedule(eventFile);
    }
    ...
    private static CrawlerRunnable createCrawlerBasedOnChoice(UrlSupplier urlSupplier, BufferedUrlList bufferedUrlList,
        ...
        case "jsoup":
            return new urlcrawler.crawler.jsoup.Crawler(urlSupplier, bufferedUrlList, indexedUrlTree);
        case "crawler4j":
            return new urlcrawler.crawler.crawler4j.CrawlerController(urlSupplier, bufferedUrlList, indexedUrlTree);
        default:
